...
This document provides guidelines for internationalization of the Qlink Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qlink_en.ts` remains unchanged.
