...
This mechanism has been integrated into Bitcore-Node-Qlink which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qlinkpay/insight-api-qlink#web-socket-api](https://github.com/qlinkpay/insight-api-qlink#web-socket-api)
* API: [https://github.com/qlinkpay/insight-api-qlink#instantsend-transactions](https://github.com/qlinkpay/insight-api-qlink#instantsend-transactions)
