# Support for Output Descriptors in Qlink Core

Since Qlink Core v0.17, there is support for Output Descriptors. This is a
...
existing Qlink Core wallets, a convenience function `combo` is
...
All RPCs in Qlink Core will include the checksum in their output. Only
