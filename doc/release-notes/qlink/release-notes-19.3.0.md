...
- `wipetxes`: New command for `qlink-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/qlinkmr/compare/v19.2.0...qlinkpay:v19.3.0).
