...
At the first startup Qlink Core will run a migration process which can take
...
incompatible with older versions of Qlink Core, so a db migration path was
...
See detailed [set of changes](https://github.com/qlinkmr/compare/v19.1.0...qlinkpay:v19.2.0).
