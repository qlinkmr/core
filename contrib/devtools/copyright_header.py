...
Arguments:
    <base_directory> - The base directory of a Qlink Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Qlink Core developers'
...
Arguments:
    <base_directory> - The base directory of Qlink Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Qlink Core repository.
"""
