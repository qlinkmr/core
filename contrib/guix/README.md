# Bootstrappable Qlink Core Builds

This directory contains the files necessary to perform bootstrappable Qlink
Core builds.
...
To build Qlink Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Qlink Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/qlink-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/qlinkpay/guix.sigs).
...
[guix-docker]: https://github.com/qlinkmr/tree/master/contrib/guix/Dockerfile
