...
//! Interface for the src/evo part of a qlink node (qlinkd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a qlink node (qlinkd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a qlink node (qlinkd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a qlink node (qlinkd process).
...
//! Top-level interface for a qlink node (qlinkd process).
class Node
{
public:
    virtual ~Node() {}
