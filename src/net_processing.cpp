 ...
 *  We have 4 times smaller block times in Qlink, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Qlink Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // QL this code also handles non-TXs (Qlink specific messages)
