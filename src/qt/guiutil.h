...
/** Utility functions used by the Qlink Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qlink:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load qlink specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a qlink specific theme is activated (light/dark).*/
