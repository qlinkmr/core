...
class UpgradeWalletTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        raise SkipTest("Test wallet_upgradewallet.py is not adapted for Qlink Core yet.")
    ...
    def setup_nodes(self):
        ...
        # adapt qlink.conf, because older qlinkd's don't recognize config sections
    ...
    def run_test(self):
        ...
        # Copy the 0.16.3 wallet to the last Qlink Core version and open it:
        ...
        self.stop_node(0)
        # Copy the 0.15.2 wallet to the last Qlink Core version and open it:
        shutil.rmtree(node_master_wallet_dir)
        os.mkdir(node_master_wallet_dir)
        shutil.copy(
            v15_2_wallet,
