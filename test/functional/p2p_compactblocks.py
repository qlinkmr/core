...
# TestP2PConn: A peer we use to send messages to qlinkd, and store responses.
...
#            "-txindex",
    ...
    # This test actually causes qlinkd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that qlinkd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for qlinkd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # qlinkd will not send blocktxn responses for blocks whose height is
