...
"""Test the qlink specific ZMQ notification interfaces."""
...
from test_framework.test_framework import QlinkTestFramework
...
class QlinkZMQTest (QlinkTestFramework):
    def set_test_params(self):
        ...
        self.set_qlink_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_qlink_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that qlinkd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all qlink related ZMQ publisher
