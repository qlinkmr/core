...
from test_framework.messages import qlinkhash, hash256
...
def qlinkhash_reversed(byte_str):
    return qlinkhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], qlinkhash_reversed(block[:80]).hex())
