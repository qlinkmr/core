...
"""Verify that starting qlinkd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qlinkd with -h for help text")
        ...
        self.log.info("Start qlinkd with -version for version information")
        ...
        self.log.info("Start qlinkdd with -fakearg to make sure it does not start")
